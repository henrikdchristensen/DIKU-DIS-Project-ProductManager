            ...
            <div className='text-center mb-8'>
                <div className='relative'>
                    <div className="absolute top-0 left-0 py-3 flex items-center justify-start">
                        <button className="flex items-center space-x-1 p-2 bg-gray-400 text-white rounded-full"
                ...
                <label className='block text-xl text-gray-500'>{data["name"]}, {data["owned_by"]}</label>
            </div>
            <div className='flex justify-center space-x-[8%] mb-10'>
                <div className="w-full max-w-[20rem]">
                    <div className=''>
                        <label className="block pl-2 text-gray-700 font-bold text-lg mb-2" htmlFor="textarea">Parameters</label>
                        <Table 
                            columns={[]} 
                    ...
                    <div className='mt-6'>
                        <label className="block pl-2 text-gray-700 font-bold text-lg mb-2" htmlFor="textarea">Journal</label>
                        <textarea
                ...
                <div className="w-full max-w-[20rem]">
                    <label className="block pl-2 text-gray-700 font-bold text-lg mb-2" htmlFor="textarea">Produced Products</label>
                    <Table 
